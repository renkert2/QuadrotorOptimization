...
for i = 1:N
    ...
    cpvdata(1).Value = d.SPECS.Weight;
    cpvdata(2).Value = d.SPECS.Diameter;
    cpvdata(3).Value = d.CONSTANTS.kV;
    cpvdata(4).Value = d.CONSTANTS.Rm;
    cpvdata(5).Value = d.CONSTANTS.Io;
    cpvdata(6).Value = d.SPECS.Maximum_Amps;
